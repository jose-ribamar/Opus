...
<!-- pega os dados de cadastro e lava ate a cpnexao atraves do metodo POST -->
                      ...
                      <form action="../candidatos/cadastrese_vaga.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                        ...
                        <!-- tabela empregador -->
                          ...
                          <div class="col-lg-6 col-12">
                            <input type="hidden" class="form-control" name="txt_usuario" placeholder="nome de usuário" value='<?= $dad[2]?>'>
                          ...
                          <div class="col-lg-6 col-12">
                            <input type="hidden" class="form-control" name="txt_email" placeholder="Email" value='<?= $dad[4]?>'>
                          </div>
