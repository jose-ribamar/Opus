          ...
          <a class="navbar-brand" href="index.html">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
                ...
                <ul class="navbar-nav ml-auto">
                        ...
                        <a href="index.php" class="nav-link contact">Voltar</a>
                    </li>
                </ul>
            </div>
        </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-6 mx-auto col-md-7 col-12 py-5 mt-5 text-center" data-aos="fade-up">
                      ...
                      <h1 class="mb-4">LOGIN <strong>  </strong>
    ...
    <form method="POST" action="login_usu.php">
        ...
        <p> Ainda não tem uma conta? <a href="login.html"><strong>Cadastre-se</strong></a></p>
                    ...
                    <!-- casso o usuario ja tenha uma conta ele precisa apenas fazer um login -->
                      <form action="perfil_fun.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
...
<!--  caso o  usuario nao tenha conta ele precisa fazer uma conta -->
        ...
        <center>
            <form method="POST" action="redefinir_senha.php">
                ...
                <p> Esqueceu sua senha? <a href="redefinir_senha.php"><strong>Redefinir senha</strong></a></p>
            </form>
          </center> 
          <center>
            <form method="POST" action="login.php">
                
                <p> Ainda não tem uma conta? <a href="tipo_conta.html"><strong>Cadastre-se</strong></a></p>
            </form>
          </center> 
     </section>
