...
<!-- pega os dados de cadastro e lava ate a cpnexao atraves do metodo POST -->
                      ...
                      <form action="actualizarvagas.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                          ...
                          <div class="col-lg-12 col-12">
                            <textarea class="form-control" rows="6" name="txt_descricao" placeholder='<?= $dados[3]?>'><?= $dados[3]?></textarea>
                          </div>
