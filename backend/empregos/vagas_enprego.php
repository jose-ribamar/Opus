        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="vagas_enprego.php#project" class="nav-link">Vagas em Destaques</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a href="blog.php" class="nav-link active">Procura Por Oportunidades</a>
                    </li> -->
                    <li class="nav-item">
                        <a href="../logar/gru" class="nav-link contact">Entrar com outra conta</a>
                    </li>
                </ul>
            </div>
        </div>
          ...
          <div class="container">
               <div class="row">
                 <div class="col-lg-12 col-12 py-5 mt-5 mb-3 text-center">
                      ...
                      <h1 class="mb-4" data-aos="fade-up">Vagas Disponiveis</h1>
                  </div>
        ...
        if (!isset($_GET['busca'])) {
          ...
          <table class="table">
            ...
            while($dados=mysqli_fetch_array($sql_consulta)){
              ...
              $id_ = $_POST['id_'];
              $sql=mysqli_query($ligar, "SELECT *FROM tb_usuarios WHERE id='$id_' ");
        ...
        ?>
            ...
            <tbody>
                      <tr class="table-info">
                        ...
                        <td>
                          <form action="../vagas/info_vagas.php" method="POST" class="contact-form" data-aos="fade-up"  role="form">
                        <div class="row">
                            <input type="hidden" name="codigo"  value='<?= $dado[0]?>'>
                        </div>
                        ...
                        <td>
                          <form action="../vagas/cadastre-se.php" method="POST" class="contact-form" data-aos="fade-up"  role="form">
                        <div class="row">
                            <input type="hidden" name="codi"  value='<?= $dado[0]?>'>
                        </div>
                        
                        <div class="row">
                            <input type="hidden" name="cod"  value="<?= $dados['id_vagas']?>">
                        </div>

                        

                          <div class="nav-item">
                            <button type="submit" class="button" name="submit">CADASTRE-SE</button>
                        </div>
                      </form>
                    </td>
                ...
                while($dados = $sql_query->fetch_assoc()) {
                    ...
                    <tbody>
                      <tr class="table-info">
                        ...
                        <td><a  href="../vagas/info_vagas.php?codigo=<?=$dados['id_vagas'] ?>"   id="editar">Mais infomações</td>
                        <td><a  href="../vaga/cadastre-se.php?codi=<?=$dados['id_vagas'] ?>"   id="editar">CANDIDATAR - SE</td>
                      </tr>
        ...
        ?>
            ...
            <tbody>
                      <tr class="table-info">
                        ...
                        <td><a  href="cadastre-se.php?codi=<?=$dado[0] ?>"   id="editar">CANDIDATAR - SE</td>
                      </tr>
                    ...
                    <div class="col-lg-7 col-md-7 col-12 mb-4" id="project">
                      <div class="blog-header" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="blog-header-info">
                          ...
                          <h3><a href="###">Programador front-end senior</a></h3>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12 mb-4">
                      <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="###">Venha ser uma pateta no Huestation, canal 5 estrelas</a></h3>
                        </div>
                      </div>
                      ...
                      <div class="blog-sidebar py-4 d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="###">Ajude a obra a continuar</a></h3>
                        </div>
                      </div>
                      ...
                      <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="###">Seja um entregador</a></h3>
                        </div>
                      </div>
