...
<!-- pega os dados de cadastro e lava ate a cpnexao atraves do metodo POST -->
                      ...
                      <form action="cadastar_emprego_tab.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                          ...
                          <div class="col-lg-6 col-12">
                            <input type="date" class="form-control" name="data_cadastro" placeholder="data de cadastro" >
                          </div>
                          ...
                          <div class="col-lg-12 col-12">
                            <textarea class="form-control" rows="6" name="descricao" placeholder="Descrição da vaga" ></textarea>
                          </div>

                          <div class="col-lg-5 mx-auto col-7">
                            <button type="submit" class="form-control" id="submit-button" name="Enviar">Cadastrar Emprego</button>
                          </div>
                        </div>
          ...
          <form method="POST" action="../logar/grupo_usuarios.php">
        <center>
