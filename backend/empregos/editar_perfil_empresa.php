...
<!-- pega os dados de cadastro e lava ate a cpnexao atraves do metodo POST -->
                      ...
                      <form action="actualizar_empresa.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                          ...
                          <input type="text" class="form-control" name="txt_sexo" placeholder="tipo de empresa" value='<?= $dados[5]?>'>
                          </div>

                          <input type="hidden" class="form-control" name="txt_nivel" value="Empregador">
                         
                          <div class="col-lg-12 col-12">
                            <textarea class="form-control" rows="6" name="txt_descricao" placeholder='<?= $dados[7]?>'><?= $dados[7]?></textarea>
                          </div>
