        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="index.html#about" class="nav-link">Sobre a Plataforma</a>
                    </li>
                    <li class="nav-item">
                        <a href="index.html#project" class="nav-link">Vagas em Destaques</a>
                    </li>
                    <li class="nav-item">
        ...
        ?>
            ...
            <tbody>
                      <tr class="table-info">
                        ...
                        <td><a  href="index_usu.php?codigo=<?=$dados['id_vagas'] ?>"   id="editar">Realizar login</td>
                        <td>
                ...
                while($dados = $sql_query->fetch_assoc()) {
                    ...
                    <tbody>
                      <tr class="table-info">
                        ...
                        <td><a  href="index_usu.php?codi=<?=$dados['id_vagas'] ?>"   id="editar">Realizar login</td>
                      </tr>
                    ...
                    <div class="col-lg-7 col-md-7 col-12 mb-4">
                      <div class="blog-header" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="blog-header-info">
                          ...
                          <h3><a href="blog-detail.html">Programador front-end senior</a></h3>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12 mb-4">
                      <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="blog-detail.html">Venha ser uma pateta no Huestation, canal 5 estrelas</a></h3>
                        </div>
                      </div>
                      ...
                      <div class="blog-sidebar py-4 d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="blog-detail.html">Ajude a obra a continuar</a></h3>
                        </div>
                      </div>
                      ...
                      <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="blog-info">
                          ...
                          <h3><a href="blog-detail.html">Seja um entregador</a></h3>
                        </div>
                      </div>
