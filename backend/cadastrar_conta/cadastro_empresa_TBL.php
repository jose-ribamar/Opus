...
$sql_cadastro = mysqli_query($ligar, "INSERT INTO tb_empregador (nome, usuario, senha, email, nivel, descricao) values ('$nome','$usuario','$senha' ,'$email', '$nivel','$descricao')");
...
//  caso nao tenha realizado o cadastro
    echo "<script>
        ...
        window.location.href='cadastro_empresa.php';
    </script>";
