...
<!-- pega os dados de cadastro e lava ate a cpnexao atraves do metodo POST -->
                      ...
                      <form action="cadastro_empresa_TBL.php" method="POST" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                          <div class="col-lg-6 col-12">
                            <input type="text" class="form-control" name="txt_nome" placeholder="Nome da empesa">
                          </div>
                          ...
                          Perguntas de recuperação de senha:
                            ...
                            <input type="text" class="form-control" name="recupera_senha" placeholder="Respostas">
                          </div> -->
                          ...
                          <div class="col-lg-6 col-12">
                            <input type="text" class="form-control" name="txt_sexo" placeholder="Tipo de empresa">                        
                          </div>

                         
                            <input type="hidden" class="form-control" name="txt_nivel" value="Empregador">
                          
                          <div class="col-lg-12 col-12">
                            <textarea class="form-control"   rows="6" name="txt_descricao" placeholder="Descriçao da empresa"></textarea>
                          </div>
